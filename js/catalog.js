...
const bookContainer = document.getElementById("catalog-container");

books.forEach(
  (el) =>
    (bookContainer.innerHTML += `
    <div class="book-card">
    <a href="book.html?id=${el.id}"><img src="${el.image}" alt="${el.title}"></a>
                <div class="book-info">
                    <h3>${el.title}</h3>
                    <p>${el.price}</p>
                    <a href="order.html?id=${el.id}"><button class="add-to-cart">Купить</button></a>
                </div>
            </div>`)
);
